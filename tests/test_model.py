...
class TregTestCase(EnseignerTestCase):
    ...
    def testGetFind(self):
        ...
        tr2 = model.TutorRegistration.create(s1, t3, 3, None)
        tr3 = model.TutorRegistration.create(s2, t3, 3, None)
        self.assertEqual(set(model.TutorRegistration.all_for_session_tutor(s1, t3)), {tr2})
        self.assertEqual(set(model.TutorRegistration.all_for_session_tutor(s2, t3)), {tr3})
        self.assertEqual(set(model.TutorRegistration.all_for_session_tutor(s2.sid, t3.uid)), {tr3})
        self.assertEqual(set(model.TutorRegistration.all_for_session_tutor(s2, t2)), set())
        self.assertRaises(model.ForeignKeyNotMapped, model.TutorRegistration.all_for_session_tutor, 50, t2)
        self.assertRaises(model.ForeignKeyNotMapped, model.TutorRegistration.all_for_session_tutor, s2, 50)
